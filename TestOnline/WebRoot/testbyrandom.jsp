...
<body>
    ...
    <%int tiankong=1;
    int jianda=1; %>
    <form action="${pageContext.request.contextPath}/StuServlet?action=testbyrandom&username=${username}" method="post" align="center">
    <ul class="seachform" >
  ...
  <br>
  <br>
  <h3 align="center"><font color="red">选择题（10分/题）</font>
  </h3>
 ...
 <h3 align="center"><font color="red">判断题（10分/题）</font></h3>
  ...
  <h3 align="center"><font color="red">填空题（10分/题）</font>
