...
<body>
    ...
    <ul class="toolbar">
        ...
        <li> <input  type="text" id="index" name="index" placeholder="请输入班级" class="find" /></li>
    ...
    <form action="${pageContext.request.contextPath}/SecServlet"
												 method="post">
    <input type="hidden" name="action" value="exportstudent"/>
    
    <ul class="toolbar">
    	  <li>班级：</li>    
	 <li> <input  type="text" id="index" name="classname" placeholder="请输入班级" class="find" /></li>
    ...
    <p><a href="${pageContext.request.contextPath}/SecServlet?action=findByStudentID&id=${n.id}&key=student">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:if(confirm('确定要删除吗？')) location='${pageContext.request.contextPath}/SecServlet?action=deletestudent&id=${n.id}&key=student'">删除</a></p>
    </li>
    </c:forEach>
